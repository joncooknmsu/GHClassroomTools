#!/usr/bin/python3
#
# Get Repos: uses a simple CSV input file to get student repositories
# - clones if the repo is not yet cloned, otherwise does a pull
# - assumes that things are going to merge well and no interaction
#   is needed
#
# NOTE: this script is mostly superceded by "ghgetrepos.py" which uses 
#       the CSV file that you can download from GitHub Classroom for
#       and assignment. TODO: the scripts should be merged.
#
# Usage: getrepos.py <input-file> [--room=<classroom>] [--assign=<assignment>]
# 
